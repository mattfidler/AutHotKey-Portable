...
!define NAME "AutoIt3WindowInfoSpyPortable"
!define PORTABLEAPPNAME "AutoIt3 Window Info Spy Portable"
!define APPNAME "AutoIt3WindoInfoSpy"
!define VER "1.5.6.0"
!define WEBSITE "PortableApps.com/development/test"
!define DEFAULTEXE "AU3_Spy.exe"
...
;=== Icon & Stye ===
!define MUI_ICON "..\..\App\AppInfo\appicon3.ico"
...
Section "Main"
	...
	BackupHCR:
		...
		${registry::MoveKey} "HKEY_LOCAL_MACHINE\Software\Classes\AutoHotkeyScript" "HKEY_LOCAL_MACHINE\Software\Classes\Applications\AutoHotkeyScriptBackupByAutoIt3WindoInfoSpyPortable" $R0
		${registry::MoveKey} "HKEY_LOCAL_MACHINE\Software\Classes\.ahk" "HKEY_LOCAL_MACHINE\Software\Classes\.ahk-BackupByAutoIt3WindoInfoSpyPortable" $R0	
		${registry::MoveKey} "HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\App Paths\AU3_Spy.exe" "HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\App Paths\AU3_Spy.exe-BackupByAutoIt3WindoInfoSpyPortable" $R0		
	...
	SetOriginalKeyBack:
		...
		${registry::MoveKey} "HKEY_LOCAL_MACHINE\Software\Classes\Applications\AutoHotkeyScriptBackupByAutoIt3WindoInfoSpyPortable" "HKEY_LOCAL_MACHINE\Software\Classes\AutoHotkeyScript" $R0
		...
		${registry::MoveKey} "HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\App Paths\AU3_Spy.exe-BackupByAutoIt3WindoInfoSpyPortable" "HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\App Paths\AU3_Spy.exe" $R0		
